...
select set_config('app.organisation_id','${ids.outsiderOrganisation}',true);
select count(*)::text from core.evidence where source_id='${ids.source}' and resource_id='${ids.resource}';
rollback;`);
